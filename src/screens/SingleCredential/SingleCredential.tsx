...
import { findImageFromCreeds, getHumanReadableDateTIme, isHex } from '../../shared/helper';
                ...
                <div className="col-12 mb-3">
                    {isPending || !data ? (
                        ...
                        <div className="single-credential">
                            ...
                            <div className={`metadata ${selectedIndex == 0 ? 'd-blok' : 'd-none'}`}>
                                <div className="json">
                            ...
                            <div className={`spaces ${selectedIndex == 1 ? 'd-flex' : 'd-none'}`}>
